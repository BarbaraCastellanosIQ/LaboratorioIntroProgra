class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine("Ejercicio de laboratorio/Automóvil-Semana 10/Bárbara Castellanos - 1049923");
        ...
        Console.WriteLine("Tipo cambio de moneda de dólar a quetzales: " + auto_1.tipoCambioDolar);
        Console.WriteLine("Descuento aplicado al autommóvil: " + auto_1.descuentoAplicado);
